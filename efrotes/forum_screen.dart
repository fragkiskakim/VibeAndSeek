...
class PostCard extends StatefulWidget {
  ...
  const PostCard({
    super.key,
    required this.userId, // Use userId instead of username
  ...
  Future<void> _fetchUsername() async {
    try {
      ...
      if (userDoc.exists) {
        ...
        setState(() {
          username = 'Unknown User'; // Fallback for missing user
        });
      }
    } catch (e) {
      if (kDebugMode) {
      ...
      setState(() {
        username = 'Error'; // Handle errors gracefully
      });
    }
  }
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    child: Image.network(
                      widget.imageUrl,
                      fit: BoxFit.contain, // Use contain to ensure the image is not cropped
