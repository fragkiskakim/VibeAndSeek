        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 20,
              child: IconButton(
                icon: Image.asset('assets/images/plus_icon.png', width: 25, height: 25),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const CreatePostScreen()),
...
class _PostCardState extends State<PostCard> with SingleTickerProviderStateMixin {
  ...
  Future<void> likePost() async {
    ...
    final likedPostRef = FirebaseFirestore.instance.collection('Liked_Posts').doc(likedPostId);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Image.asset('assets/images/account_icon.png', width: 30, height: 30),
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    Image.asset('assets/images/pillar_icon.png', width: 20, height: 20),
                    const SizedBox(width: 8),
                    Text(
                      widget.caption,
                      style: const TextStyle(
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      icon: Image.asset(
                        isLiked ? 'assets/images/like_icon.png' : 'assets/images/like_icon_outline.png',
                        width: 24,
                        height: 24,
                      ),
