...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Future<void> _uploadPost() async {
    ...
    try {
      ...
      // Step 2: Add post to Firestore
      await FirebaseFirestore.instance.collection('Posts').add({
        'caption': _captionController.text, // User's caption
        'image_url': imageUrl, // Image URL from Storage
        'likes_count': 0, // Default likes
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          const Color(0xFFF2EBD9), // Match the app's background color
      body: SafeArea(
        child: Column(
          children: [
            const SimpleHeader(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        fillColor: const Color(
                            0xFFD19348), // Match input field background
