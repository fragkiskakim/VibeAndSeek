...
// Initialize completion status for all words in initState
  ...
  void navigateToWinScreen() {
    ...
    FirebaseFirestore.instance
      ...
      // Fetch the user's document to filter out already used coupons
        ...
        FirebaseFirestore.instance
            ...
            .set(
              ...
              DateTime.now().millisecondsSinceEpoch.toString(): {
                ...
                SetOptions(
                    merge: true)) // Merge to avoid overwriting existing coupons
            .then((_) {
                      ...
                      content: Row(
                        children: [
                          ...
                          const Text(
                            ...
                            style: TextStyle(
                              fontFamily: 'Finlandica',
                              color: Color(0xFF003366), // SnackBar text color
                            ),
                          ),
                        ],
                      ),
                      backgroundColor:
                          const Color(0xFFF2EBD9), // SnackBar background color
                    ),
                  );
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
